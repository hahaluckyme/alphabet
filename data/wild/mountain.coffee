export MountainCampsiteEmpty = new class extends Room
  discovered: false
  take_chair: false
  take_pot: false
  take_bottles: false
  ...
  choices: =>
    if not Logan.met
      ...
      south: => await Player.location = CaveOutside
    else
  ...
  AngryMountaineer: =>
    ...
    await Player.location = MountainCampsiteCaptured


export MountainCampsiteCaptured = new class extends Room
  times_begged: 0
  cried: false
